...
#define WIFI_NETWORK_INTERNAL_EVENT_MASK WIFI_NETWORK_EVENT_BIT_STA_BEACON_TIMEOUT | WIFI_NETWORK_EVENT_BIT_STA_BSS_RSSI_LOW | WIFI_NETWORK_EVENT_BIT_AP_PROBEREQRECVED | WIFI_NETWORK_EVENT_BIT_STA_AUTHMODE_CHANGE
